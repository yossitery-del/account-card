...
| רכיב | נוסח |
|------|------|
| כותרת (עם שם) | `{inviterDisplayName} רוצה לשתף איתך כרטיס חשבון` |
| כותרת (בלי שם) | רוצים לשתף איתך כרטיס חשבון |
| טקסט ראשי | מקום פרטי ומסודר לראות ולעדכן בו את מצב החשבון ביניכם. |
| שורת ערך (עדינה) | ברור, נוח, וללא בלגן בין הודעות וצילומי מסך. |
